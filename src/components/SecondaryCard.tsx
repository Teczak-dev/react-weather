            ...
            <div className="p-4 space-y-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p>{Math.floor((data.sys.sunset - data.sys.sunrise) / 3600)} hours {(Math.floor((data.sys.sunset - data.sys.sunrise) % 3600 / 60))} minutes</p>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p>UTC {data.timezone >= 0 ? `+${data.timezone / 3600}` : `${data.timezone / 3600}`}</p>
                    </div>
                </div>
            </div>
        </Card>
